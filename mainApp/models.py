...
class Patient(models.Model):
    name = models.CharField(max_length=100, default="Joseph")
...
class Room(models.Model):
    ...
    type = models.CharField(choices=roomType, default='w')
...
class Admission(models.Model):
    ...
    roomID = models.ForeignKey(Room, on_delete=models.SET_NULL, related_name='patient_admitted')
    startTime = models.DateTimeField()
...
class Operation:
    ...
    opTheatre = models.ForeignKey(Room, related_name='where', validators=[_validate_room])
    startTime = models.DateTimeField()
    endTime = models.DateTimeField()
